...
<?php
		...
		?>
			...
			<header class="major">
							<h1>Category : LOVE</h1>
							<h5>Other Categories : &nbsp <a href="scifi.php">Scientic Fiction</a> &nbsp&nbsp&nbsp&nbsp&nbsp <a href="life.php">Life</a> &nbsp&nbsp&nbsp&nbsp&nbsp<a href="others.php">Others</a>
							</h5>
						</header>
			</section>
			<?php
			require_once("love_cont.php");
		?>
		</section>
				<?php
