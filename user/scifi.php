...
<?php
		...
		?>
			...
			<section>
			<header class="major">
							<h1>Category : Scientific Fiction</h1>
							<h5>Other Categories : &nbsp <a href="love.php">Love</a> &nbsp&nbsp&nbsp&nbsp&nbsp <a href="life.php">Life</a> &nbsp&nbsp&nbsp&nbsp&nbsp<a href="others.php">Others</a>
							</h5>
						</header>
			</section>
			<?php
			require_once("scifi_cont.php");
		?>
		</section>
				<?php
