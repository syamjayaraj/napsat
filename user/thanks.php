...
<?php
		...
		?>
			...
			<div id="main">
					<section id="one">
						<header class="major">
							<h2>Your Nap posted successfully</h2>
						</header>
						<h5>Note that , </h5>
									<ul class="alt">
										<li>Your Nap is shown to all Napsat members</li>
										<li>You can always delete them from <a href="urworks.php">Your Naps</a> page</li>
										<li>For any queries , feel free to <a href="contact.php">contact</a> us</li>
									</ul>
						<ul class="actions">
